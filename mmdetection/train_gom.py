...
def main():
    ...
    """
    # Config 파일 로드 및 수정
    cfg = Config.fromfile('./configs/faster_rcnn/faster_rcnn_r50_fpn_1x_coco.py')  # 모델 설정
    cfg.work_dir = './work_dirs/ggomji_novalid'                      # 로그/모델 저장 위치
    ...
    cfg.runner = dict(type='EpochBasedRunner', max_epochs=25)                      # epoch 수 설정
