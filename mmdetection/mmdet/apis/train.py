...
def train_detector(model,
    ...
    # Replace default CheckpointHook with CustomCheckpointHook
    checkpoint_hook_cfg = cfg.checkpoint_config
    checkpoint_hook = CustomCheckpointHook(**checkpoint_hook_cfg)
