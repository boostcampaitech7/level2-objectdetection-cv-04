...
def parse_args():
    ...
    parser.add_argument('--work-dir', default='./work_dirs/#17. 10090813_cascade_rcnn_x101_32x4d_larger_swin_22k_imgscale_720_PAFPN_loss_1x_trash', help='the dir to save logs and models')
