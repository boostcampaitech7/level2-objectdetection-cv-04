...
def parse_args():
    ...
    parser.add_argument('--work-dir', default='./work_dirs/#A-2. ImageSize VS Batch: Size', help='the dir to save logs and models')
...
def main():
    ...
    submission.to_csv(os.path.join(cfg.work_dir, f'submission_b1{args.checkpoint}.csv'), index=None)
