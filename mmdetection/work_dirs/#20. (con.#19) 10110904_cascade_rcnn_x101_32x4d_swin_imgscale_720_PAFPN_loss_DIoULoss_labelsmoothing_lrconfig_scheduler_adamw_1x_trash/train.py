...
def parse_args():
    ...
    parser.add_argument('--work-dir', default='./work_dirs/#20. (con.#19) 10110904_cascade_rcnn_x101_32x4d_swin_imgscale_720_PAFPN_loss_DIoULoss_labelsmoothing_lrconfig_scheduler_adamw_1x_trash', help='the dir to save logs and models')
...
def main():
    ...
    cfg.data.train.pipeline[2]['img_scale'] = (540,540)

    cfg.data.test.classes = classes
    cfg.data.test.img_prefix = root
    cfg.data.test.ann_file = root + 'test.json'
    cfg.data.test.pipeline[1]['img_scale'] = (540,540)
