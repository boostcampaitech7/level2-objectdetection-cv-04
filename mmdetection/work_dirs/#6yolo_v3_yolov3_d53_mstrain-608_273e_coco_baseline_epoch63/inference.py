...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default='epoch_63', help='checkpoint to use')
...
def main():
    ...
    # Update this part for YOLO
    if hasattr(cfg.model, 'bbox_head'):
        cfg.model.bbox_head.num_classes = 10
    elif hasattr(cfg.model, 'roi_head'):
        cfg.model.roi_head.bbox_head.num_classes = 10
    else:
        raise AttributeError("Unable to find bbox_head or roi_head in model config")
