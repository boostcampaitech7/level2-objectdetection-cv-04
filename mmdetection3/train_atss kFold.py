...
def main():
    ...
    for i in range(args.fold):
        ...
        cv_cfg.val_evaluator.classwise = True
        cv_cfg.test_evaluator.ann_file = osp.join(args.data_root, 'test.json')

        cv_cfg.param_scheduler[0] = dict(type='LinearLR', start_factor=0.001, by_epoch=False, begin=0, end=500)
        cv_cfg.param_scheduler[1] = scheduler_list[(i)%2]
