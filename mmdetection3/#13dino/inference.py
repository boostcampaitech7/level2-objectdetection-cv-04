...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default='/data/ephemeral/home/hanseonglee/level2-objectdetection-cv-04/mmdetection3/work_dirs/fold1/best_coco_bbox_mAP_50_epoch_8.pth', help='체크포인트 파일 경로')
    parser.add_argument('--data-root', default='/data/ephemeral/home/dataset/', help='데이터셋 루트 디렉토리')
    parser.add_argument('--output-dir', default='inference_results/dino_kfold1', help='결과 저장 디렉토리')
    parser.add_argument('--score-thr', type=float, default=0.01, help='점수 임계값')
