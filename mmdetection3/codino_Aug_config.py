...
optimizer_config = dict(
    cumulative_iters=1, type='GradientCumulativeOptimizerHook')
param_scheduler = [
    dict(milestones=[
        4,7,11
    ], gamma = 0.1 , type='MultiStepLR'),
]
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        backend_args=None,
        data_prefix=dict(img='/data/ephemeral/home/dataset/test/'),
        data_root='/data/ephemeral/home/dataset/',
        metainfo=dict(
            classes=(
                'General trash',
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        backend_args=None,
        data_prefix=dict(img='/data/ephemeral/home/dataset/train/'),
        data_root='/data/ephemeral/home/dataset/',
        metainfo=dict(
            classes=(
                'General trash',
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        backend_args=None,
        data_prefix=dict(img='/data/ephemeral/home/dataset/val/'),
        data_root='/data/ephemeral/home/dataset/',
        metainfo=dict(
            classes=(
                'General trash',
...
vis_backends = [
    ...
    dict(
        init_kwargs=dict(
            entity='jongseo001111-naver', project='co_dino_swin_l_epoch12'),
...
work_dir = './work_dirs/codino_swinl'
