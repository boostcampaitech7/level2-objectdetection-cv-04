...
def parse_args():
    parser = argparse.ArgumentParser(description="CenterNet 모델 추론2")
    parser.add_argument('--config', default='./work_dirs/codino_swinl/20241022_140842/vis_data/config.py', help='설정 파일 경로')
    parser.add_argument('--checkpoint', default='/data/ephemeral/home/Hongjoo/mmdetection/work_dirs/codino_swinl/best_coco_bbox_mAP_50_epoch_10.pth', help='체크포인트 파일 경로')
    parser.add_argument('--data-root', default='/data/ephemeral/home/dataset/', help='데이터셋 루트 디렉토리')
    parser.add_argument('--output-dir', default='inference_results/codino_e12', help='결과 저장 디렉토리')
...
def main():
    ...
    visualizer.dataset_meta = {'classes': classes}  # 클래스 이름 설정
    ...
    for idx, img_path in enumerate(tqdm(test_imgs)):
        ...
        # mmcv.imwrite(img_with_text, os.path.join(args.output_dir, f'result_{idx}.png'))
