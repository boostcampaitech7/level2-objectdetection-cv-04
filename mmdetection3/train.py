...
def parse_args():
    ...
    parser.add_argument('--work-dir', default='./work_dirs/v9', help='로그와 모델을 저장할 디렉토리')
    ...
    parser.add_argument('--pretrained', default='./pretrained/cascade_rcnn_x101_32x4d_fpn_20e_coco_20200906_134608-9ae0a720.pth', help='Pretrained 모델 경로 (Optional)')
...
#     cfg.neck = dict(
#     type='PAFPN',
#     in_channels=[384, 768, 1536, 3072],  # Swin Transformer의 아웃풋 채널
#     out_channels=256,  # FPN에서 사용하는 출력 채널
#     num_outs=5,  # FPN에서 몇 개의 피라미드 레벨을 생성할지 설정
#     start_level=0,  # 몇 번째 레벨부터 사용할지 (0은 모든 레벨 사용)
#     add_extra_convs='on_input',  # 추가 피라미드 레벨을 생성할지
#     relu_before_extra_convs=True  # 추가 Convs 전에 ReLU 적용
# )
