...
def main():
    ...
    # cfg.train_dataloader.dataset.dataset.ann_file = osp.join(args.data_root, 'train.json')
    # cfg.train_dataloader.dataset.dataset.data_prefix.img = osp.join(args.data_root, 'train')
    ...
    # cfg.val_dataloader.dataset.dataset.data_prefix.img = osp.join(args.data_root, 'val')
