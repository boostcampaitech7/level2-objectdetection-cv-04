...
def parse_args():
    parser = argparse.ArgumentParser(description="Train a efficientdet model")
    # Config 관련 argument
    parser.add_argument('--config', default='./configs/efficientdet/efficientdet_effb3_bifpn_8xb16-crop896-300e_coco (1).py', help='config file path')
