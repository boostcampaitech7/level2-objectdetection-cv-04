...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default='/data/ephemeral/home/backup/level2-objectdetection-cv-04/mmdetection3/work_dirs/detr_r50_8xb2-150e_coco_trash/epoch_50.pth', help='체크포인트 파일 경로')
